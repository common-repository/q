        ...
        */
        ...
        public function q_simple_SEO( $length = 155, $echo = true ){
            ...
            if( is_category() || is_archive() ) {
                ...
                $meta_desc = get_post_meta( $id, "metadescription", true );
                if ( !$meta_desc ) { // custom field not set - use excerpt ##
        ...
        <?php
            ...
            } elseif ( file_exists( q_get_option("path_parent").'favicon.png' ) ) { // load from parent ##
        ...
        public function q_google_analytics() {
            ...
            if ( class_exists( 'Q_Control' ) && method_exists( 'Q_Template', 'the_analytics' ) ) {
