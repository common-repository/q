...
if ( ! class_exists( 'Q_Map' ) )
{
    ...
    <script type="text/javascript">
        ...
        function loadScript() {
            ...
            script.type = 'text/javascript';
            script.src = 'https://maps.googleapis.com/maps/api/js?key=<?php echo $this->api_key; ?>&v=3.exp&sensor=false&'+'callback=initialize';
    ...
    <?php
        ...
        public function wp_enqueue_scripts() {
                ...
                wp_register_style( 'q-map', q_locate_template( "css/q.map.css", false ), array( 'q-reset' ), '0.1', 'all' );
